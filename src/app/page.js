      ...
      <section className="py-24 bg-foreground relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link 
                href="/signup" 
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-xl text-primary bg-white hover:bg-zinc-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                Get Started Now
              </Link>
          </div>
